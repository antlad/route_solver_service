...
pkg_search_module(PC_LibOSRM REQUIRED libosrm)
...
find_path(LibOSRM_INCLUDE_DIR osrm/osrm.hpp
        ...
        HINTS ${CMAKE_INSTALL_PREFIX} ${PC_LibOSRM_INCLUDEDIR} ${PC_LibOSRM_INCLUDE_DIRS}
        ~/Library/Frameworks
        /Library/Frameworks
        /usr/local
        /usr
...
find_library(TEST_LibOSRM_STATIC_LIBRARY Names osrm.lib libosrm.a
        ...
        HINTS ${CMAKE_INSTALL_PREFIX} ${PC_LibOSRM_LIBDIR} ${PC_LibOSRM_LIBRARY_DIRS}
        ~/Library/Frameworks
        /Library/Frameworks
        /usr/local
        /usr
